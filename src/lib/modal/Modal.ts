...
export function getModalSlots({ className, size, open }: ModalProps) {
	...
	return {
		...
		modalHeader: 'text-lg font-semibold text-gray-900 px-5 py-4',
		modalHeaderCloseIcon: 'cursor-pointer p-2 mr-4 rounded hover:bg-gray-300',
